...
export function useBookings() {
  ...
  return {
    ...
    getById: (id: string) => state.bookings.find((booking) => booking.id === id) ?? null,
    createBooking: bookingRepository.create,
    requestCancel: bookingRepository.requestCancel,
    acceptCancelRequest: bookingRepository.acceptCancelRequest,
    rejectCancelRequest: bookingRepository.rejectCancelRequest,
    cancelByBusiness: bookingRepository.cancelByBusiness,
    payBalance: bookingRepository.payBalance,
